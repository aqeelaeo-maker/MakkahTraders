                ...
                <div className="flex justify-between items-start mb-1 relative z-10">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="grid grid-cols-[auto_auto] gap-x-2 gap-y-1 items-end text-right">
                      ...
                      <span className="text-[16px] font-bold text-gray-900 leading-none">{invoiceNumber}</span>
                  ...
                  <table className="w-full text-[13px] mb-4 relative z-10 border-collapse border border-gray-800">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="py-6 px-4 font-bold text-[18px] text-center border border-gray-800">{subtotal.toLocaleString()}</td>
                        <td className="py-6 px-4 font-bold text-[18px] text-center border border-gray-800">{totalTax.toLocaleString()}</td>
                        <td className="py-6 px-4 font-bold text-[18px] text-center border border-gray-800">{(subtotal + totalTax).toLocaleString()}</td>
                      </tr>
                    </tbody>
                  </table>
                )}
                  ...
                  <div className="w-1/2">
                    <div className="bg-gray-50 p-3 rounded border border-gray-300 text-[14px]">
                      <div className="flex justify-between py-1.5">
                        ...
                        <span className="font-bold text-[16px]">{subtotal.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between py-1.5 border-b border-gray-300">
                        ...
                        <span className="text-[18px] font-bold">{totalTax.toLocaleString()}</span>
                      </div>
                      {discount > 0 && (
                        <div className="flex justify-between py-1.5 border-b border-gray-300 text-red-600">
                          <span className="font-bold">Discount:</span>
                          <span className="font-bold text-[16px]">-{discount.toLocaleString()}</span>
                        </div>
                      )}
